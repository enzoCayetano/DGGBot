...
module.exports = {
  ...
  // Roles allowed to run the command
  ...
  async execute(interaction)
  {
    ...
    const title = rawTitle.length > 20 ? rawTitle.substring(0, 20) + '...' : rawTitle;
    ...
    try
    {
      // Send poll and react with emojis
